...
export namespace Prisma {
  ...
  */
  ...
  export type TodosOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "email" | "data", ExtArgs["result"]["todos"]>
  ...
  interface TodosFieldRefs {
    ...
    readonly email: FieldRef<"Todos", 'String'>
  ...
  export type TodosWhereInput = {
    ...
    email?: StringFilter<"Todos"> | string
  ...
  export type TodosScalarWhereWithAggregatesInput = {
    ...
    email?: StringWithAggregatesFilter<"Todos"> | string
